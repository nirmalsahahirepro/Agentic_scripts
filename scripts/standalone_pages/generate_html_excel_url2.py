...
data = [
    {
        ...
        "testcase expected result": "Prompt for email or route directly to checks.",
        "testcase actual result": "Navigated directly to dashboard without prompt.",
    ...
    },
    {
        ...
        "testcase name": "SEB Component Detection",
        "testcase description": "Verify if the system detects Safe Exam Browser environment.",
        "testcase steps": "1. Open URL in standard Chrome.\n2. Observe Safe Browser check.",
        "testcase expected result": "Identify as 'No' in standard Chrome.",
        "testcase actual result": "Safe Browser Compatible: No",
        "testcase status": "PASS",
        "testcase remarks": "Accurate detection.",
        "testcase severity": "High",
        "testcase priority": "P1"
    },
    {
        ...
        "testcase expected result": "Show green check and active sound bar upon allow.",
        "testcase actual result": "Perm granted, green checkmarks present, sound active.",
        "testcase status": "PASS",
    ...
    },
    {
        ...
        "testcase actual result": "Down: 44.03 Mbps, Up: 24.92 Mbps",
        "testcase status": "PASS",
...
<html>
<head>
    <title>QA Test Report - URL 2 SEB Compatibility</title>
    <style>
...
<body>
    <div class="container">
        <h1>QA Test Report - URL 2 SEB System Compatibility Check</h1>
        <div class="env-info">
            <strong>Target URL:</strong> https://amsin.hirepro.in/assessment/#/compatibility/at/seb<br>
...
html_path = "/home/nirmalsaha/Hirepro_Test_files/automation_scripts/agents/antigravity/assessments/agentic_scripts/output_reports/standalone_pages/qa_report_url2_seb_styled_2026-03-09.html"
...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Worksheet ss:Name="QA Report URL 2">
  <Table>
...
xml_path = "/home/nirmalsaha/Hirepro_Test_files/automation_scripts/agents/antigravity/assessments/agentic_scripts/output_reports/standalone_pages/qa_report_url2_seb_colorcoded_2026-03-09.xls"
